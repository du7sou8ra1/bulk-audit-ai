...
const TOOL_DEFS: { key: keyof Toggles; label: string; hint: string }[] = [
  ...
  { key: 'aderyn', label: 'Aderyn', hint: 'Rust static analyzer (Cyfrin)' },
  { key: 'analyzer_findings', label: 'Analyzer findings', hint: 'Promote Slither/Mythril/Semgrep/Aderyn hits to findings' },
  { key: 'chain_liveness', label: 'Chain liveness', hint: 'Drop wrong-chain / codeless-target findings' },
